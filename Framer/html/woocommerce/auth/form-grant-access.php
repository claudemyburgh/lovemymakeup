...
<p class="wc-auth-actions">
	<a href="<?php echo esc_url( $granted_url ); ?>" class="btn btn-primary wc-auth-approve"><?php _e( 'Approve', 'woocommerce' ); ?></a>
	<a href="<?php echo esc_url( $return_url ); ?>" class="btn wc-auth-deny"><?php _e( 'Deny', 'woocommerce' ); ?></a>
</p>
